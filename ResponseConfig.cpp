...
void ResponseConfig::setHttpStatusCode(void) {
  int i;
  std::string key[35] = {"405", "200", "201", "202", "206", "301", "302",
                         "303", "307", "400", "401", "404", "406", "408",
                         "411", "413", "414", "416", "431", "400", "401",
                         "404", "406", "408", "411", "413", "414", "416",
                         "431", "500", "501", "417", ""};
  std::string value[35] = {"Method Not Allowed",
                           "OK",
                           "Created",
                           "Accepted",
                           "Partial Content",
...
std::string ResponseConfig::getContentType(std::string filename) {
  ...
  for (iter = supportedTypesRepo.begin(); iter != supportedTypesRepo.end();
       iter++) {
